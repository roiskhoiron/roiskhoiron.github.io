          ...
          items: [
            {
              label: "Dart Language",
              items: [
                { label: "Variables & Data Types", link: "/mobile/flutter-fundamentals/dart-variables-data-types/" },
                { label: "Functions", link: "/mobile/flutter-fundamentals/dart-functions/" },
                { label: "OOP", link: "/mobile/flutter-fundamentals/dart-oop/" },
                { label: "Null Safety", link: "/mobile/flutter-fundamentals/dart-null-safety/" },
                { label: "Error Handling", link: "/mobile/flutter-fundamentals/dart-error-handling/" }
              ]
            },
            {
              label: "UI Development",
              items: [
                { label: "Widget", link: "/mobile/flutter-fundamentals/widget/" },
                { label: "Layout", link: "/mobile/flutter-fundamentals/layout/" },
                { label: "Responsive Design", link: "/mobile/flutter-fundamentals/responsive-design/" },
                { label: "Theme Management", link: "/mobile/flutter-fundamentals/theme-management/" },
                { label: "Accessibility", link: "/mobile/flutter-fundamentals/accessibility/" }
              ]
            },
            {
              label: "Navigation",
              items: [
                { label: "Navigator", link: "/mobile/flutter-fundamentals/navigator/" },
                { label: "Named Route", link: "/mobile/flutter-fundamentals/named-route/" },
                { label: "Deep Linking", link: "/mobile/flutter-fundamentals/deep-linking/" },
                { label: "Route Management", link: "/mobile/flutter-fundamentals/route-management/" }
              ]
            },
            {
              label: "State Management",
              items: [
                { label: "setState", link: "/mobile/flutter-fundamentals/setstate/" },
                { label: "Provider", link: "/mobile/flutter-fundamentals/provider/" },
                { label: "Riverpod", link: "/mobile/flutter-fundamentals/riverpod/" },
                { label: "State Architecture", link: "/mobile/flutter-fundamentals/state-architecture/" }
              ]
            },
            {
              label: "Local Storage",
              items: [
                { label: "Shared Preferences", link: "/mobile/flutter-fundamentals/shared-preferences/" },
                { label: "Hive", link: "/mobile/flutter-fundamentals/hive/" },
                { label: "SQLite", link: "/mobile/flutter-fundamentals/sqlite/" }
              ]
            },
            {
              label: "Networking",
              items: [
                { label: "HTTP", link: "/mobile/flutter-fundamentals/http/" },
                { label: "Dio", link: "/mobile/flutter-fundamentals/dio/" },
                { label: "REST API", link: "/mobile/flutter-fundamentals/networking-rest-api/" },
                { label: "API Error Handling", link: "/mobile/flutter-fundamentals/api-error-handling/" }
              ]
            },
            {
              label: "Firebase",
              items: [
                { label: "Authentication", link: "/mobile/flutter-fundamentals/firebase-auth/" },
                { label: "Firestore", link: "/mobile/flutter-fundamentals/firestore/" },
                { label: "Push Notification", link: "/mobile/flutter-fundamentals/push-notification/" },
                { label: "Analytics", link: "/mobile/flutter-fundamentals/firebase-analytics/" },
                { label: "Crashlytics", link: "/mobile/flutter-fundamentals/crashlytics/" }
              ]
            },
            {
              label: "Testing",
              items: [
                { label: "Unit Test", link: "/mobile/flutter-fundamentals/unit-test/" },
                { label: "Widget Test", link: "/mobile/flutter-fundamentals/widget-test/" },
                { label: "Integration Test", link: "/mobile/flutter-fundamentals/integration-test/" }
              ]
            },
            {
              label: "Deployment",
              items: [
                { label: "APK & AAB", link: "/mobile/flutter-fundamentals/apk-aab/" },
                { label: "App Signing", link: "/mobile/flutter-fundamentals/app-signing/" },
                { label: "Play Store Release", link: "/mobile/flutter-fundamentals/play-store-release/" },
                { label: "Release Strategy", link: "/mobile/flutter-fundamentals/release-strategy/" }
              ]
            },
            {
              label: "Native Integration",
              items: [
                { label: "Platform Channel", link: "/mobile/flutter-fundamentals/platform-channel/" },
                { label: "Native SDK Integration", link: "/mobile/flutter-fundamentals/native-sdk/" },
                { label: "Performance Optimization", link: "/mobile/flutter-fundamentals/performance-optimization/" }
              ]
            }
          ]
        }
