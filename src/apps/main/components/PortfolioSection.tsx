...
const projectData: Record<Language, ProjectItem[]> = {
  id: [
    ...
    },
    {
      ...
      subtitle: "Firebase Analytics untuk data produk",
      ...
      impact: "Data-driven decision making untuk tim produk",
      tags: ["Flutter", "Firebase", "Analytics", "Data-Driven"],
    },
    {
      id: 5,
      category: "production",
      ...
      impact: "Produksi — melayani komunikasi real-time pengguna",
      tags: ["Flutter", "Socket.io", "webRTC", "Node.js"],
    },
    {
      id: 6,
      category: "production",
  ...
  en: [
    ...
    },
    {
      ...
      color: "violet",
      title: "Mobile Analytics Projectile",
      subtitle: "Firebase Analytics for product data",
      ...
      impact: "Data-driven decision making for product teams",
      tags: ["Flutter", "Firebase", "Analytics", "Data-Driven"],
    },
    {
      id: 5,
      ...
      impact: "In production — serving real-time user communication",
      tags: ["Flutter", "Socket.io", "webRTC", "Node.js"],
    },
    {
      id: 6,
  ...
  zh: [
    ...
    },
    {
      ...
      icon: Layers,
      color: "violet",
      title: "移动分析 Projectile",
      subtitle: "基于 Firebase Analytics 的产品数据",
      problem: "需要实时数据洞察来驱动产品决策与应用性能优化。",
      approach: "集成 Firebase Analytics，涵盖应用性能、转化、自定义事件、功能使用、营销留存与用户行为分析。",
      impact: "为产品团队提供数据驱动决策支持",
      tags: ["Flutter", "Firebase", "Analytics", "Data-Driven"],
    },
    {
      id: 5,
      ...
      color: "rose",
      title: "Flutter Chat Realtime",
      subtitle: "基于 socket.io 与 webRTC 的聊天应用",
      problem: "需要支持聊天、语音和视频通话的实时通讯功能。",
      approach: "使用 Flutter 构建聊天应用，集成 socket.io 实现消息推送，webRTC 实现音视频通话，后端基于 Node.js。",
      impact: "已投产 — 服务用户实时通讯",
      tags: ["Flutter", "Socket.io", "webRTC", "Node.js"],
    },
    {
      ...
      title: "HappyExpress",
      subtitle: "快递员与物流管理应用",
      problem: "RDC 难以高效管理每日快递任务，包括取派件分配与追踪。",
    ...
    },
    {
      ...
      color: "blue",
      title: "QA Snap SDK",
      subtitle: "用于屏幕录制与日志捕获的 Android SDK",
      problem: "QA 团队在调试 Android 应用时难以录制屏幕和捕获日志。",
      approach: "开发开源的 Android SDK，支持 MP4 屏幕录制与 ADB 日志捕获（API 21-34）。",
      impact: "开源 — 简化 Android QA 工作流程",
      tags: ["Kotlin", "Compose UI", "MediaProjection", "QA Tools"],
    },
  ],
  ja: [
    ...
    },
    {
      ...
      color: "violet",
      title: "Mobile Analytics Projectile",
      subtitle: "Firebase Analytics によるプロダクトデータ分析",
      problem: "プロダクト判断とアプリパフォーマンス最適化のためのリアルタイムデータインサイトが必要。",
      approach: "Firebase Analytics を統合し、アプリパフォーマンス、コンバージョン、カスタムイベント、機能使用率、マーケティングリテンション、ユーザー行動分析を実現。",
      impact: "プロダクトチームのデータ駆動型意思決定を支援",
      tags: ["Flutter", "Firebase", "Analytics", "Data-Driven"],
    },
    {
      id: 5,
      ...
      color: "rose",
      title: "Flutter Chat Realtime",
      subtitle: "socket.io & webRTC 対応チャットアプリ",
      problem: "チャット、音声・ビデオ通話を備えたリアルタイムコミュニケーション機能が必要。",
      approach: "Flutter で構築したチャットアプリ。socket.io でメッセージング、webRTC で音声/ビデオ通話、Node.js バックエンド。",
      impact: "本番稼働中 — ユーザーのリアルタイムコミュニケーションを提供",
      tags: ["Flutter", "Socket.io", "webRTC", "Node.js"],
    },
    {
      id: 6,
      ...
      color: "emerald",
      title: "HappyExpress",
      subtitle: "宅配便・物流管理アプリ",
      problem: "RDC は毎日の配送業務（集荷・配達の割り当てと追跡）の管理に課題を抱えていた。",
      approach: "配送業務管理、リアルタイム追跡、レポート機能を備えた物流アプリを構築。",
      impact: "本番稼働中 — 日々の配送業務を効率化",
      tags: ["Flutter", "Firebase", "Google Maps", "Real-Time"],
    },
    {
      id: 7,
    ...
    },
    {
      ...
      color: "blue",
      title: "QA Snap SDK",
      subtitle: "画面録画・ログ取得のための Android SDK",
      problem: "QA チームは Android アプリのデバッグ時に画面録画とログ取得に課題を抱えていた。",
      approach: "MP4 画面録画と ADB ログ取得に対応したオープンソース Android SDK を開発（API 21-34）。",
      impact: "オープンソース — Android QA ワークフローを効率化",
      tags: ["Kotlin", "Compose UI", "MediaProjection", "QA Tools"],
    },
  ],
};
