...
const stageData: Record<Language, Stage[]> = {
  id: [
    ...
    },
    {
      ...
      icon: Layers,
      color: "violet",
      description: "Naik dari Senior Developer menjadi Head of Mobile, memimpin tim lintas fungsi, menata delivery lintas platform, dan membuat keputusan arsitektur sistem.",
  ...
  en: [
    ...
    },
    {
      ...
      icon: Layers,
      color: "violet",
      description: "Evolved from Senior Developer to Head of Mobile, leading cross-functional teams, driving multi-platform delivery, and making system architecture decisions.",
      skills: ["Flutter", "Jetpack Compose", "SwiftUI", "CI/CD", "Team Leadership", "Product Roadmap", "System Design"],
