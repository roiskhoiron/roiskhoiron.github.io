...
const stageData: Record<Language, Stage[]> = {
  id: [
    ...
    },
    {
      ...
      phase: "03",
      role: "Product Engineer",
      subtitle: "Integrasi & Skala",
      icon: Brain,
      color: "cyan",
      description: "Mengaplikasikan AI sebagai alat dalam pengembangan produk end-to-end — dari arsitektur sistem dan backend API hingga pengalaman mobile — untuk menyelesaikan masalah bisnis nyata.",
  ...
  en: [
    ...
    },
    {
      ...
      phase: "03",
      role: "Product Engineer",
      subtitle: "Integration & Scale",
      icon: Brain,
      color: "cyan",
      description: "Applying AI as a tool within end-to-end product development — from system architecture and backend APIs to mobile experiences — to solve real business problems.",
      skills: ["LLM Integration", "TFLite / Edge ML", "Prompt Engineering", "AI Product Design", "System Architecture", "Backend APIs"],
      coreSkills: ["OpenAI API", "Claude API", "Prompt Engineering", "RAG", "Vector DB", "TFLite", "MediaPipe", "Python", "FastAPI", "System Design", "Cloud (GCP/AWS)", "AI Agents"],
  ...
  zh: [
    ...
    },
    {
      ...
      icon: Brain,
      color: "cyan",
      description: "将 AI 作为端到端产品开发中的工具，从系统架构、后端 API 到移动端体验，解决真实的业务问题。",
      skills: ["LLM Integration", "TFLite / Edge ML", "Prompt Engineering", "AI Product Design", "System Architecture", "Backend APIs"],
      coreSkills: ["OpenAI API", "Claude API", "Prompt Engineering", "RAG", "Vector DB", "TFLite", "MediaPipe", "Python", "FastAPI", "System Design", "Cloud (GCP/AWS)", "AI Agents"],
  ...
  ja: [
    ...
    },
    {
      ...
      icon: Brain,
      color: "cyan",
      description: "AIをツールとして活用し、システムアーキテクチャからモバイル体験までのエンドツーエンド開発で現実のビジネス課題を解決。",
      skills: ["LLM Integration", "TFLite / Edge ML", "Prompt Engineering", "AI Product Design", "System Architecture", "Backend APIs"],
      coreSkills: ["OpenAI API", "Claude API", "Prompt Engineering", "RAG", "Vector DB", "TFLite", "MediaPipe", "Python", "FastAPI", "System Design", "Cloud (GCP/AWS)", "AI Agents"],
