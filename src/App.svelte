    ...
    <section class="flex flex-col items-center gap-10 text-center reveal in">
      ...
      <div class="flex flex-col items-center gap-4 reveal">
        ...
        <div class="flex flex-wrap justify-center gap-3 mt-1">
          <a href="https://play.google.com/store/apps/dev?id=8721309729295189926" target="_blank" class="inline-flex items-center gap-3 bg-white text-black rounded-xl px-4 py-2.5 hover:bg-zinc-100 transition min-w-[148px]"><img src="https://cdn.simpleicons.org/googleplay/000000" class="w-5 h-5 platform-icon" alt=""><span class="flex flex-col leading-none text-left"><span class="mono text-[9px] tracking-[0.14em] uppercase font-semibold text-zinc-500">Apps on</span><span class="text-[13px] font-semibold -mt-0.5">Google Play</span></span></a>
